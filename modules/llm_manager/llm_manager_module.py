...
from modules.llm_manager.base_bridge import (
    BaseBridge, BridgeError, ErrorCategory, ModelCapabilities, ChatResponse,
)
...
__all__ = [
    ...
    'ModelCapabilities', 'ChatResponse', 'BaseBridge', 'BridgeError',
    'ErrorCategory', 'get_local_engine_manager',
